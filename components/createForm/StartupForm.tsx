  ...
  const handleFormSubmit = async (prevState: any, formData: FormData) => {
    try {
      ...
      if(e instanceof  z.ZodError) {
        ...
        return {...prevState, e :"Validation Failed", status: 'ERROR'};
      }
      toast({
        title: "Error",
      ...
      return {...prevState, e :"An expected error has occurred", status: 'ERROR'};
    }
  }

  const [error, formAction, isPending] = useActionState(handleFormSubmit, {error: '', status:'INITIAL', });
